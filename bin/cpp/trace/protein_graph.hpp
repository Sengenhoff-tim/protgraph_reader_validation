...
class ProteinGraph {
    public:
        ...
        std::string tvs_traverse_varcount_naive(int64_t lower, int64_t upper, uint8_t max_vars, std::ofstream& trace);
        ...
        void write_intervals_compact(const std::string& path) const;
};
