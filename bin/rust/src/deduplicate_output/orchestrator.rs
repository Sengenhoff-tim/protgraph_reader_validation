...
use crate::deduplicate_output::threading::{spawn_dispatcher, spawn_writers, spawn_worker};
...
pub fn dedup_bin_files(
    ...
    let (tx_out, rx_out) = bounded::<(String, Vec<BinEntryMeta>)>(CHANNEL_CAPACITY_OUT_BASE.min(num_threads * 2));
